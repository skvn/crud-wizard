          ...
          <div style="padding:10px;">
            <div class="row">
              <div class="col-md-6 form-group">
                <label>Title *</label>
                <input type="text" name="title" class="form-control" :value="relation.title" v-model="relation.title"
                       placeholder="Title *"
                       required>
              ...
              <div class="col-md-6  form-group" v-if="relation.relation=='belongsTo' || relation.relation=='hasFile'">
                <label>Field (local key)
                  <select class="form-control default_select" name="field" v-model="relation.field"
                          :value="relation.field" required>
            ...
            <div class="col-lg-12" v-if="relation.relation=='belongsToMany'">
              <div class="checkbox"><label><input type="radio" v-model="relation.pivot" v-bind:value="0"/><b>Generate
                pivot table</b></label></div>
              <div class="checkbox"><label><input type="radio" v-model="relation.pivot" v-bind:value="1"/><b>Choose
                existing pivot table</b></label></div>
